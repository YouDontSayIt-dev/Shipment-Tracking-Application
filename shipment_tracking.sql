...
--
-- Host: localhost    Database: shipmenttracking
-- ------------------------------------------------------
...
CREATE TABLE `cargo` (
  ...
  `container_number` char(12) DEFAULT NULL,
  PRIMARY KEY (`serial_number`),
  KEY `shipment_ID_idx` (`shipment_ID`),
  KEY `container_number_idx` (`container_number`),
  CONSTRAINT `container_number` FOREIGN KEY (`container_number`) REFERENCES `container_number` (`Container_ID`),
...
-- Dump completed on 2022-06-28  7:06:43
