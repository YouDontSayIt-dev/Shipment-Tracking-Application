        ...
        if(user.equals("Admin") && password.equals("admin1")){
        ...
        else
            {
                ...
                try{
                    ...
                    String query = "SELECT * FROM staff WHERE staff_ID='"+ UserID.getText()+"' AND staff_password='"+String.valueOf(PassID.getPassword())+"'";
                    ...
                    if (rs.next()){
                        ...
                        new staff_panel(rs.getString("staff_name")).setVisible(true);  
                    }
